...
public interface MemberService {
	boolean member_join(UserDTO dto);//회원가입시 회원정보를 저장한다.(insert)
	UserDTO member_login(HashMap<String, String> map);//회원 로그인 처리(select)
	boolean member_update(UserDTO vo); //회원정보의 변경 (update)
